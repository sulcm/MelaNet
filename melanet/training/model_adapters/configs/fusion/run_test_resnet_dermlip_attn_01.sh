python run_model_adapters_training.py \
    ...
    --adapter_type fusion \
    --adapter_config "{\"in_features\":[2048,512],\"out_features\":11,\"use_attn\":true,\"attn_num_heads\":2,\"input_l2_norm\":true,\"dropout\":0.1,\"modality_dropout\":0.05,\"drop_path_rate\":0.1}" \
